...
public class DriveNotify {
	...
	public void test() throws IOException {
		...
		Thread thread = new Thread(driveThread);
		thread.start();
	}
	// HttpTransport httpTransport = new NetHttpTransport();
	// JsonFactory jsonFactory = new JacksonFactory();
	...
	// // Log.w(TAG,
	// "flow.newTokenRequest(code).setRedirectUri(REDIRECT_URI).execute() == null");
	// // if (flow.newTokenRequest(code).setRedirectUri(REDIRECT_URI) == null) {
	// // Log.w(TAG,
	// "flow.newTokenRequest(code).setRedirectUri(REDIRECT_URI) == null");
	// // if (flow.newTokenRequest(code) == null) {
